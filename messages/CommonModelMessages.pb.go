...
func (ProtoPayloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_CommonModelMessages_proto_enumTypes[0].Descriptor()
}

func (ProtoPayloadType) Type() protoreflect.EnumType {
	return &file_CommonModelMessages_proto_enumTypes[0]
}
...
func (ProtoPayloadType) EnumDescriptor() ([]byte, []int) {
	return file_CommonModelMessages_proto_rawDescGZIP(), []int{0}
}
...
func (ProtoErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_CommonModelMessages_proto_enumTypes[1].Descriptor()
}

func (ProtoErrorCode) Type() protoreflect.EnumType {
	return &file_CommonModelMessages_proto_enumTypes[1]
}
...
func (ProtoErrorCode) EnumDescriptor() ([]byte, []int) {
	return file_CommonModelMessages_proto_rawDescGZIP(), []int{1}
}

var File_CommonModelMessages_proto protoreflect.FileDescriptor

const file_CommonModelMessages_proto_rawDesc = "" +
	"\n" +
	"\x19CommonModelMessages.proto*I\n" +
	...
	"\x12\x18\n" +
	"\x14BLOCKED_PAYLOAD_TYPE\x10\vB\x1aZ\x18ctrader-openapi/messages"

var (
	file_CommonModelMessages_proto_rawDescOnce sync.Once
	file_CommonModelMessages_proto_rawDescData []byte
)

func file_CommonModelMessages_proto_rawDescGZIP() []byte {
	file_CommonModelMessages_proto_rawDescOnce.Do(func() {
		file_CommonModelMessages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CommonModelMessages_proto_rawDesc), len(file_CommonModelMessages_proto_rawDesc)))
	})
	return file_CommonModelMessages_proto_rawDescData
}

var file_CommonModelMessages_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_CommonModelMessages_proto_goTypes = []any{
	(ProtoPayloadType)(0), // 0: ProtoPayloadType
	(ProtoErrorCode)(0),   // 1: ProtoErrorCode
}
var file_CommonModelMessages_proto_depIdxs = []int32{
...
func init() { file_CommonModelMessages_proto_init() }
func file_CommonModelMessages_proto_init() {
	if File_CommonModelMessages_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CommonModelMessages_proto_rawDesc), len(file_CommonModelMessages_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_CommonModelMessages_proto_goTypes,
		DependencyIndexes: file_CommonModelMessages_proto_depIdxs,
		EnumInfos:         file_CommonModelMessages_proto_enumTypes,
	}.Build()
	File_CommonModelMessages_proto = out.File
	file_CommonModelMessages_proto_goTypes = nil
	file_CommonModelMessages_proto_depIdxs = nil
}
