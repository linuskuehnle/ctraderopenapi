...
func (x *ProtoMessage) Reset() {
	*x = ProtoMessage{}
	mi := &file_CommonMessages_proto_msgTypes[0]
...
func (*ProtoMessage) Descriptor() ([]byte, []int) {
	return file_CommonMessages_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProtoErrorRes) Reset() {
	*x = ProtoErrorRes{}
	mi := &file_CommonMessages_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProtoErrorRes) Descriptor() ([]byte, []int) {
	return file_CommonMessages_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProtoHeartbeatEvent) Reset() {
	*x = ProtoHeartbeatEvent{}
	mi := &file_CommonMessages_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProtoHeartbeatEvent) Descriptor() ([]byte, []int) {
	return file_CommonMessages_proto_rawDescGZIP(), []int{2}
}
...
var File_CommonMessages_proto protoreflect.FileDescriptor

const file_CommonMessages_proto_rawDesc = "" +
	"\n" +
	"\x14CommonMessages.proto\x1a\x19CommonModelMessages.proto\"l\n" +
	"\fProtoMessage\x12 \n" +
	...
	"\vpayloadType\x18\x01 \x01(\x0e2\x11.ProtoPayloadType:\x0fHEARTBEAT_EVENTR\vpayloadTypeB\x1aZ\x18ctrader-openapi/messages"

var (
	file_CommonMessages_proto_rawDescOnce sync.Once
	file_CommonMessages_proto_rawDescData []byte
)

func file_CommonMessages_proto_rawDescGZIP() []byte {
	file_CommonMessages_proto_rawDescOnce.Do(func() {
		file_CommonMessages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CommonMessages_proto_rawDesc), len(file_CommonMessages_proto_rawDesc)))
	})
	return file_CommonMessages_proto_rawDescData
}

var file_CommonMessages_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_CommonMessages_proto_goTypes = []any{
...
var file_CommonMessages_proto_depIdxs = []int32{
...
func init() { file_CommonMessages_proto_init() }
func file_CommonMessages_proto_init() {
	if File_CommonMessages_proto != nil {
		return
	}
	file_CommonModelMessages_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CommonMessages_proto_rawDesc), len(file_CommonMessages_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_CommonMessages_proto_goTypes,
		DependencyIndexes: file_CommonMessages_proto_depIdxs,
		MessageInfos:      file_CommonMessages_proto_msgTypes,
	}.Build()
	File_CommonMessages_proto = out.File
	file_CommonMessages_proto_goTypes = nil
	file_CommonMessages_proto_depIdxs = nil
}
